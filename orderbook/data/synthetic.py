"""
Synthetic L2 orderbook and market data generator.

Implements a "synthetic-first" strategy to simulate realistic L2 orderbook data
for analysis under data constraints.
"""
...
from orderbook.data.schemas import Trade, Quote, L2Orderbook, L2OrderbookLevel


class SyntheticDataGenerator:
    """Generate synthetic market data for testing and analysis."""
    ...
    def generate_market_session(
        ...
        prices = self.generate_price_path(total_steps, dt_seconds=60.0 / max(trades_per_minute, quotes_per_minute))
